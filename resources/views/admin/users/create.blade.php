            ...
            <div class="col-12">
                ...
                <form method="post" action="/admin/users" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="middlename" class="form-control"  name="middlename" value="{{old('middlename')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="birthdate" class="form-control"  name="birthdate" value="{{old('birthdate')}}" placeholder="dd-mm-yyyy">
                        @if($errors->has('birthdate'))
                            <span class="text-danger">{{$errors->get('birthdate')[0]}}</span>
                        @endif
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="hideyear">Hide year</label>
                        <select name="hideyear" class="form-control">
                            <option value="" selected disabled>Select hiding ...</option>
