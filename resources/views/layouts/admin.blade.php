        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <span class="navbar-dark">{{ __('Admin panel') }}</span>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        @verified
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.calendar') }}">{{ __('Calendar') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.events.categories.index') }}">
                                {{ __('Categories') }}
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.birthdays.index') }}">
                                {{ __('Birthdays') }}
                            </a>
                        </li>
                        @endverified
